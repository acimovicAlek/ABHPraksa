...
public class RegressionBrands {
    ...
    @Test(priority = 4)
    public void navigateToBrandAdd(){
        driver.findElement(By.xpath("html/body/div[1]/div[3]/div[3]/a[2]")).click();

        Assert.assertTrue(
                driver.findElement(By.xpath(".//*[@id='new_brand']/div/h2")).isDisplayed()
        );
    }

    @Test(priority = 5)
    public void addBrand(){
        driver.findElement(By.id("brand_name")).sendKeys("TEST");
        driver.findElement(By.xpath(".//*[@id='new_brand']/div/input")).click();

        List<WebElement> brands = driver.findElements(By.xpath("html/body/div[1]/table/tbody/tr"));
        boolean cond = false;
        for (WebElement i:
                brands) {
    ...
    public void deleteBrand(){
        ...
        categories = driver.findElements(By.xpath("html/body/div[1]/table/tbody/tr"));

        Assert.assertNotEquals(cond, categories.size());
