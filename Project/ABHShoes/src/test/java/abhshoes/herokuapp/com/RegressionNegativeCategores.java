 ...
 */
public class RegressionNegativeCategores {
    ...
    public void emptyCategory(){
        ...
        Assert.assertTrue(driver.findElement(By.xpath(".//*[@id='new_category']/div/input")).isDisplayed());
        }catch (Exception e){
            cond = false;
    ...
    @Test(priority = 6)
    public void whitespaceCategory(){
        driver.findElement(By.xpath(".//*[@id='new_category']/div/input")).sendKeys("     ");
        driver.findElement(By.xpath(".//*[@id='new_category']/div/input")).click();
