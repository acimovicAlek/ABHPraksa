 ...
 */
public class RegressionNegativeBrands {
    WebDriver driver;
    WebDriverWait wait;
    ...
    public void whitespaceBrand(){
        ...
        try{
            Assert.assertEquals(driver.findElement(By.xpath("html/body/div[1]/div[1]")).getText(),
                    "Name can't be blank");
            Assert.assertTrue(driver.findElement(By.xpath(".//*[@id='new_brand']/div/input")).isDisplayed());
        }catch (Exception e){
            cond = false;
